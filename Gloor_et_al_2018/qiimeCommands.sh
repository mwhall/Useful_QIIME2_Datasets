...
qiime dada2 denoise-paired --i-demultiplexed-seqs reads.qza --o-table unfiltered_table --o-representative-sequences representative_sequences --p-trunc-len-f 240 --p-trunc-len-r 240 --p-n-threads 4 --o-denoising-stats denoise_stats.qza --verbose
